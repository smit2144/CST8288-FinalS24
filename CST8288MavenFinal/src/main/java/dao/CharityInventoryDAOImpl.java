...
/**
 * Implementation of the InventoryDAO interface  customized for charity inventory management.
 * This class provides methods to retrieve surplus items intended for donation from the database.
 * @author Hussein
 */

public class CharityInventoryDAOImpl implements InventoryDAO {
	
	/**
	 * Retrieve Surplus items marked for donation
	 * @return list of objects representing surplus inventory items for donation 
	 */
	...
	public List<InventoryDTO> getSurplus() {
        ...
        try {
            ...
            String sql = "SELECT * FROM fooditems WHERE SurplusStatus = 'yes' AND Plan = 'donation'";
	...
	/**
     * Retrieve  inventory item by  ID from database.
     * 
     * @param itemId of the inventory item to be retrieved.
     * @return  InventoryDTO object representing the retrieved inventory item.
     */
