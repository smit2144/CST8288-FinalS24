...
@WebServlet("/retailer/editInventory")
public class RetailerEditInventoryServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            if (inventory != null) {
                ...
                request.getRequestDispatcher("/retailer/editInventory.jsp").forward(request, response);
            } else {
