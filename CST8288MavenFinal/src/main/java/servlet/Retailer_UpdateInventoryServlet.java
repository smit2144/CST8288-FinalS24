...
*/
@WebServlet(name = "Retailer_UpdateInventoryServlet", urlPatterns = {"/Retailer_UpdateInventoryServlet"})
public class Retailer_UpdateInventoryServlet extends HttpServlet {
